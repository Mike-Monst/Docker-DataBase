...
$bgcolor='ffeebb';
  ...
  echo("<br><h4>Tickets</h4> ");

  echo("<center><table border=0><tr bgcolor=$tcolor0>");
  echo("<td align=center nowrap><b>Lfd. Nr.</b></td>");
  echo("<td align=center nowrap><b>Ticket ID</b></td>");
  echo("<td align=center nowrap><b>LetzterChange</b></td>");
  echo("<td align=center nowrap><b>User</b></td>");
  echo("<td align=center nowrap><b>Typ</b></td>");
  echo("<td align=center nowrap><b>Inhalt</b></td>");
  echo("<td align=center nowrap><b>Status</b></td>");

  $query="select tid,ticket_timestamp,ticket_user,ticket_type,ticket_content,ticket_state from dslprov_tickets where ticket_visprefnum like '$vc_visprefnum' order by ticket_timestamp desc";
  $result=mysql_query($query);
