...
//  $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state>9 and vc_state <22";
 ...
 echo "AKT $action";
  ...
  if ($action=='searchvc')
    ...
    if ($vc_conn_company!='')
      {
      $st21="vc_conn_company like '%$vc_conn_company%'";
      }
    else
      {
      $st21=1;
...
// aenderung fuer Login realm
    ...
    if ($vc_conn_houseno!='')
      {
      $st23="vc_conn_houseno like '$vc_conn_houseno%'";
      }
    else
      {
      $st23=1;
    ...
    if ($vc_conn_contactphonepre!='')
      {
      $st24="vc_contactphonepre like '%$vc_conn_contactphonepre%'";
      $nst24="subscriber_prefix like '%$vc_conn_contactphonepre%'";
      $numberquery=1;
      }
    else
      {
    ...
    if ($vc_conn_contactphone!='')
      {
      $st25="vc_contactphone like '%$vc_conn_contactphone%'";
      $nst25="subscriber_number like '%$vc_conn_contactphone%'";
      $numberquery=1;
      }
    else
      {
    ...
    if ($vc_housetype!='')
      {
      $st26="vc_housetype like '%$vc_housetype%'";
      }
    else
      {
      $st26=1;
...
//    if ($sterror==20) { $st8='0000000000'; }
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where $st1 and $st2 and $st3 and $st4 and $st5 and $st6 and $st7 and $st8 and $st9 and $st10 and $st11 and $st12 and $st13 and $st14 and $st15 and $st16 and $st17 and $st18 and $st19 and $st20 and $st21 and $st22 and $st23 and $st24 and $st25 and $st26 ORDER by vc_conn_street,vc_conn_houseno";

if ($numberquery==1)
  {
    $query="select distinct vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc, dslprov_vc_subscribernumbers where $st1 and $st2 and $st3 and $st4 and $st5 and $st6 and $st7 and $st8 and $st9 and $st10 and $st11 and $st12 and $st13 and $st14 and $st15 and $st16 and $st17 and $st18 and $st19 and $st20 and $st21 and $st22 and $st23 and subscriber_visprefnum = vc_visprefnum and (($st24 and $st25) or ($nst24 and $nst25)) and $st26 ORDER by vc_conn_street,vc_conn_houseno";  
  }      
...
// echo("$query");
    ...
    $query="select t1.vc_conn_surname,t1.vc_conn_postcode,t1.vc_cli,t1.vc_conn_street,t1.vc_conn_city,t1.vc_cbuk,t1.productadditional_id,hardware_id,portprovider_id,t1.userbw_id,t1.usercr_id,t1.vc_commitdate,t1.vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,t1.vc_installationdate,vc_productiondate,t1.vc_state,t1.vc_vci,t1.vp_id,t1.vcfault_id,t1.vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc as t1 left join dslprov_vp as t2 on t1.vp_id = t2.vp_id where t2.vp_id LIKE '$vp_id'";
    }

  else if ($action=='searchvc_ex') 
    {
    echo("<h3>Customers on exchange $exchange_id</h3>");
    $query="select t1.vc_conn_surname,t1.vc_conn_postcode,t1.vc_cli,t1.vc_conn_street,t1.vc_conn_city,t1.vc_cbuk,t1.productadditional_id,hardware_id,portprovider_id,t1.userbw_id,t1.usercr_id,t1.vc_commitdate,t1.vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,t1.vc_installationdate,vc_productiondate,t1.vc_state,t1.vc_vci,t1.vp_id,t1.vcfault_id,t1.vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc as t1 left join dslprov_vp as t2 on t1.vp_id = t2.vp_id where t2.exchange_id LIKE '$exchange_id'";
    }
    ...
    $query="select t1.vc_conn_surname,t1.vc_conn_postcode,t1.vc_cli,t1.vc_conn_street,t1.vc_conn_city,t1.vc_cbuk,t1.productadditional_id,hardware_id,portprovider_id,t1.userbw_id,t1.usercr_id,,t1.vc_commitdate,t1.vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,t1.vc_installationdate,vc_productiondate,t1.vc_state,t1.vc_vci,t1.vp_id,t1.vcfault_id,t1.vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc as t1 left join dslprov_vp as t2 on t1.vp_id = t2.vp_id where t2.cal_id LIKE '$cal_id'";
    }
// reporting fake
  else if ($action=='last3')
    {
    $time=time();
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state>21";
    }

  else if ($action=='ordertracking')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where (vc_state>22 and vc_state<26) order by vc_reqdeliverydate";
    }

  else if ($action=='exceptions')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state<5";
    }
    ...
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=22 order by vc_reqdeliverydate";
    }
  else if ($action=='preorder')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=21 order by vc_reqdeliverydate";
    }
  else if ($action=='preorder20')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=20 order by vc_reqdeliverydate";
    }
  else if ($action=='orderinstdate')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=26 order by vc_commitdate";
    }
  else if ($action=='orderreinstallation')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=27 order by vc_commitdate";
    }
  else if ($action=='orderinstallationday')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=28 order by vc_commitdate";
    }
  else if ($action=='orderinstallation')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=29 order by vc_installationdate desc";
    }
  else if ($action=='orderprod')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state>29 AND vc_state<40 order by vc_productiondate desc,vc_conn_surname asc";
    }
  else if ($action=='orderprod38')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=38 order by vc_productiondate desc,vc_conn_surname asc";
    }
  else if ($action=='orderprod39')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=39 order by vc_productiondate desc,vc_conn_surname asc";
    }
  else if ($action=='orderprod32')
    {
    $query="select vc_visprefnum,vc_conn_company,vc_conn_title,vc_conn_surname,vc_conn_firstname,vc_conn_postcode,vc_conn_city,vc_conn_citysubloc,vc_conn_street,vc_conn_houseno,vc_email,product_id,productcap_id,productadditional_id,hardware_id,portprovider_id,vc_reqdeliverydate,asap_id,vc_newreqdate,vc_newreqtime,vc_errorcode,vc_commitdate,vc_installationdate,vc_productiondate,vc_state,vcfault_id,vc_id,vc_confirmations,vc_conn_contactphonepre,vc_conn_contactphone,vc_comments,vc_contact_email from dslprov_vc where vc_state=32 order by vc_productiondate desc,vc_conn_surname asc";
    }
...
// VISP , Realm
  ...
  echo("<td align=center nowrap><b>AuftragNr.<br>ErfDatum</b></td>"); 
...
#        echo("<td align=center>$tvalue</td>");
        ...
        if ($action=='exceptions')
          ...
          {  
          $checkconfirminfo= 1 & $value;
          $checkabinfo= 2 & $value;
          $checkebinfo= 4 & $value;
          
          echo("<td align=center>");
//          echo("<img border=0 src=images/green.gif>");

          if ($checkabinfo==0)
            {
            echo("<a href=index.php?page=$page&action=$action&limit=$limit&changeab=$vref><img border=0 src=images/red.gif></a>");
            }
            else
            {
            echo("<a href=index.php?page=$page&action=$action&limit=$limit&resetab=$vref><img border=0 src=images/green.gif></a>");
            }

          if ($checkconfirminfo==0)
//          if ($value==0)
            {
            echo("<a href=index.php?page=$page&action=$action&limit=$limit&changeinfo=$vref><img border=0 src=images/red.gif></a>");
            }
            else
            {
            echo("<img border=0 src=images/green.gif>");
        ...
        {
        echo("<td align=center>$j18 $j19 $value<br>---<br>$j20</td>");
        }
