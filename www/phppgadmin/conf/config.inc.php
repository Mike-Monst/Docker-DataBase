<?php
	...
	$conf['servers'][0]['desc'] = 'dbm2pgt';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][0]['host'] = 'dbm2.mwerk.net';
	...
	// Display name for the server on the login screen
	$conf['servers'][1]['desc'] = 'geo2local10';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][1]['host'] = '172.16.1.57';
	...
	// Specify the path to the Slony SQL scripts (where slony1_base.sql is located, etc.)
	// No trailing slash.
	$conf['servers'][1]['slony_sql'] = '/usr/share/slony1';


	// Display name for the server on the login screen
	$conf['servers'][2]['desc'] = 'geodb2';

	// Hostname or IP address for server.  Use '' for UNIX domain socket.
	// use 'localhost' for TCP/IP connection on this computer
	$conf['servers'][2]['host'] = '141.101.36.13';
	...
	// Specify the path to the Slony SQL scripts (where slony1_base.sql is located, etc.)
	// No trailing slash.
	$conf['servers'][2]['slony_sql'] = '/usr/share/slony1';
