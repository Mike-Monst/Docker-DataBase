...
//echo($repdays);
  ...
  echo("<td align=left nowrap><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0><TR><TD BGCOLOR=amber><IMG SRC=\"/images/placeholder.gif\" WIDTH=$w1 HEIGHT=10 ALT=\"\"></TD><TD BGCOLOR=yellow><IMG SRC=\"/images/placeholder.gif\" WIDTH=$w2 HEIGHT=10 ALT=\"\"></TD><TD BGCOLOR=orange><IMG SRC=\"/images/placeholder.gif\" WIDTH=$w3 HEIGHT=10 ALT=\"\"></TD></TR></TABLE></td>");
  echo("<td align=center nowrap><b>&nbsp;</b></td>");
