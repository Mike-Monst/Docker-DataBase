<?php
/* $Id: config.inc.php3,v 1.46 2001/10/24 12:56:25 lem9 Exp $ */
...
$cfgServers[1]['host']          = 'db93.puretec.de'; // MySQL hostname
...
// wsda
$cfgServers[1]['user']          = 'p33675770';      // MySQL userM
$cfgServers[1]['password']      = 'testdat1';          // MySQL password (only
$cfgServers[1]['only_db']       = 'db65775458';          // If set to a db-name
...
$cfgMaxRows               = 50;     // maximum number of rows to display in browse mode
