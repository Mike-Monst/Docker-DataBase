...
<option value=gustav>gustav internet (Glasfaser Endkunden)</option><option value=novanetz>novanetz (Glasfaser Endkunden)</option><option value=hugo selected>hugo internet (VDSL Endkunden)</option><option value=werknetz>werknetz internet (Glasfaser Business)</option><option value=swn>swn Neuwied</option><option value=innogyhvv>innogy HVV</option></select><br /></td></tr>
